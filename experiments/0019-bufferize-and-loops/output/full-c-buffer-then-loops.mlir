...
module attributes {transform.with_named_sequence} {
  ...
  transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.consumed}) {
    ...
    %1 = transform.bufferization.one_shot_bufferize %arg0 : (!transform.any_op) -> !transform.any_op
    %2 = transform.structured.match ops{["linalg.matmul"]} in %1 : (!transform.any_op) -> !transform.any_op
    %3 = transform.structured.convert_to_loops %2 : (!transform.any_op) -> !transform.any_op
    transform.yield 
  }
}
